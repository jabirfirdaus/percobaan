...
?>
	...
	<table class="table">
		...
		while ($data=mysqli_fetch_array($result_produk)) {
			...
			<tr>
				...
				<td align="center">
					<a href="edit.php?id=<?= $data['produk_id'] ?>" class="edit">Ubah</a>
					<a href="delete.php?id=<?= $data['produk_id'] ?>" onclick="return confirm('Apakah Anda Yakin Produk <?= $data['nama_produk'] ?> akan dihapus')" class="delete">Hapus</a>
				</td>
			</tr>
			<?php 
			$no++;
	...
	<a href="form.php" class="add">Tambah Produk</a>
	</div>
<br>
