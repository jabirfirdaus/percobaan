...
$bulan=$thn."-".$blns;
?>
<h2>Laporan Penjualan <br>Bulan : <?= $blns ?>-<?= $thn ?></h2>
<table width="100%">
	<tr>
...
<br>
<a href="bulanan_print.php?bln=<?= $blns ?>&thn=<?= $thn ?>" class="cetak" target="_blank">Cetak</a>
<a href="index.php" class="cetak">Batal</a>
</body>
</html>