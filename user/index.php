		...
		while ($data=mysqli_fetch_array($result)) {
			...
			<tr>
				...
				<td align="center">
					...
					<a href="delete.php?id=<?= $data['user_id'] ?>" onclick="return confirm('Apakah Anda Yakin Petugas <?= $data['nama_user'] ?> akan dihapus')" class="delete">Hapus</a>
				</td>
			</tr>
			<?php 
			$no++;
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Registrasi Petugas</h5>
